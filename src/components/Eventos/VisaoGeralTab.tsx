  ...
  return (
    <div className="space-y-8">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <StatCard icon={DollarSign} label="Valor Total" value={evento.totalValue.toLocaleString('pt-BR', { style: 'currency', currency: 'BRL' })} color="text-green-500" />
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        <div className="bg-white dark:bg-brand-gray-800 rounded-lg shadow-md p-6 border border-brand-gray-200 dark:border-brand-gray-700">
          ...
          <div className="space-y-4 text-sm">
              ...
              <InfoItem icon={Clock} label="Horário" value={`${evento.startTime} - ${evento.endTime}`} />
