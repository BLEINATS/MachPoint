/*
  # [Operation Name]
  [This operation provides a definitive fix for the reservation creation error by correcting multiple function signature mismatches. It safely drops and recreates the reservation, duplicate-checking, and profile-creation functions to ensure their parameters are perfectly aligned.]
...
DECLARE
    v_end_time time;
BEGIN
    -- Handle overnight bookings (e.g., ends at 00:00)
