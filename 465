...
BEGIN
    ...
    IF public.check_duplicate_reservation(p_arena_id, p_quadra_id, p_date, p_start_time, p_end_time) THEN
    ...
    IF v_gamification_enabled THEN
        PERFORM public.add_gamification_points(v_aluno_id, 1, 'Reserva criada', 'reservation_completed', v_reserva_id, p_arena_id);
    END IF;
